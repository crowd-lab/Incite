<?php
class Incite_Users_Table extends Omeka_Records
{
    /**
     ...
     */
    public static function isUserActive($email)
    {
        $count = 0;
        $db = parent::getDB();
    ...
    public static function changeExperienceLevel($email, $experienceLevel)
    {
        $db = parent::getDB();
     ...
     *
     */
    public static function deactivateAccount($email)
    {
        $db = parent::getDB();
    ...
    public static function reactivateAccount($email)
    {
        $db = parent::getDB();
    ...
    public static function createAccount($email, $password, $firstName, $lastName, $privilege, $experienceLevel)
    {
        $count = 0;
        $db = parent::getDB();
