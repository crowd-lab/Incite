...
<?php foreach ((array)$this->Discussions as $discussion): ?>
                    <li class="list-group-item">
                        <a href="<?php echo getFullInciteUrl().'/discussions/discuss/'.$discussion['id']; ?>"><?php echo $discussion['title']; ?></a> - created by <a href="#"><?php echo $discussion['user_first_name']; ?></a><span class='db_time'><?php echo $discussion['time']; ?></span><span class="badge">Replies: <?php echo $discussion['num_of_replies']; ?></span>
                    </li>
<?php endforeach; ?>
                </ul>
            </div>
