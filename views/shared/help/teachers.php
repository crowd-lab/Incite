    ...
    <div style="margin-top: 20px;" class="col-md-6 col-md-offset-3">
        <div class="panel panel-default">
            ...
            <div style="padding: 15px;">
                ...
                <p>If you are planning to use the site with your students, please contact us at <a href="mailto:july4.civilwar-g@vt.edu">july4.civilwar-g@vt.edu</a>. We can provide personalized guidance on how to make the most of Mapping the Fourth, and may even be able to discover new primary sources to suit your students' specific needs.</p>
        ...
        <div class="panel panel-default">
            ...
            <div style="padding: 15px;">
                ...
                <ul>
                    ...
                    <li>Archival research project with document discovery</li>
                    <li>Semester-long research project for an advanced course in U.S. history</li>
                </ul>
              Please click <a target="_blank" href="https://drive.google.com/file/d/0BznofpP3hDdgcWI3anI1anhQdlE/view">here</a> for more details.
            </div>
        </div> 
    </div>
    <div class="col-md-12">
