            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Section 2</h3>
                </div>
                <div style="padding: 15px;">
                    <div class="form-group">
                        <div>
                            <div><label>How mentally demanding was the task?</label></div>
                    ...
                    <div class="form-group">
                        <div>
                            <div><label>How physically demanding was the task?</label></div>
                    ...
                    <div class="form-group">
                        <div>
                            <div><label>How hurried or rushed was the pace of the task?</label></div>
                    ...
                    <div class="form-group">
                        <div>
                            <div><label>How successful were you in accomplishing what you were asked to do?</label></div>
                    ...
                    <div class="form-group">
                        <div>
                            <div><label>How hard did you have to work to accomplish your level of performance?</label></div>
                            <label class="radio-inline"><input type="radio" name="tlx_eff" value="1">1 (very low)</label>
                    ...
                    <div class="form-group">
                        <div>
                            <div><label>How insecure, discouraged, irritated, stressed, and annoyed were you?</label></div>
