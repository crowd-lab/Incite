                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="phase2-panel" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="correcting" name="correcting">The worker corrected all existing tags with correct categorical information.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="coverage1" name="coverage1">The worker tagged all required types of tags.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="coverage2" name="coverage2">The worker did not tag non-required types of tags.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="completeness" name="completeness">The worker provided categorical information for all tags.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="correctnames" name="correctnames">The worker tagged correct tag names based on instructions.</label>
                                        </div>
                                        <div class="checkbox">
                                        ...
                                        <p>Q1: How effective are the tags?</p>
                                        ...
                                        <p>Q2: How effective are the categorical information?</p>
    ...
    $(document).ready(function () {
        ...
        $('#phase1-button').on('click', function(e) {
            ...
            if (check_input_baseline()) {
                ...
                //Add to taglist
                var row = "<tr><td>";
                row += "New Windsor" + "</td><td>" + "Location" + "</td><td>" + "City";
                row += "</td></tr>";
                $("#taglist").append(row);
                row = "<tr><td>";
                row += "Bedford" + "</td><td>" + "Location" + "</td><td>" + "City";
                row += "</td></tr>";
                $("#taglist").append(row);
                row = "<tr><td>";
                row += "Bedford" + "</td><td>" + "Location" + "</td><td>" + "City";
                ...
                $("#taglist").append(row);
                row = "<tr><td>";
                row += "Col. Maylans Regiment" + "</td><td>" + "Organization" + "</td><td>" + "Military";
                row += "</td></tr>";
                $("#taglist").append(row);
