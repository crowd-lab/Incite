                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="phase2-panel" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <p>Your theme reasoning: <div style="padding: 2px; background-color: #eee;" id="ori-subjectreasoning"></div></p>
                                        <hr>
                                        <p><b>Self Assessment: </b></p>
                                        <p>Checklist:</p>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="understanding" name="understanding">I read and understood the definition of each theme.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="usefulness" name="usefulness">I made ratings based on how useful the document on the left could help a historian research the themes.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="reasoning" name="reasoning">I provided convincing reasons why the document is useful for research some of the themes if any.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="reasoningdegree" name="reasoningdegree">I provided convincing reasons why the document is useful with the specified degrees for research some of the themes if any.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="evidence" name="evidence">I provided concrete evidence from the document why the document is useful for research some of the themes if any.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="reasoningnot" name="reasoningnot">I provided convincing reasons why the document is NOT useful for research some of the themes if any.</label>
                                        </div>
                                        <p>Q1: How effective are your theme ratings?</p>
...
*/
            ...
            $('#phase1-button').on('click', function(e) {
                ...
                if (check_input_baseline()) {
                    ...
                    <?php foreach ((array)$this->subjects as $subject): ?>
                    $('#ori-subject<?php echo strtolower($subject['id']); ?>').text(valueToDescription($('input[name="subject<?php echo $subject['id']; ?>"]:checked').val()));
                    <?php endforeach; ?>
                    $('#ori-subjectreasoning').text($('#subjectreasoning').val());
