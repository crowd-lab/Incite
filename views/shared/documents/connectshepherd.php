                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="phase2-panel" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="usefulness" name="usefulness">I made ratings(connections) based on how useful the document on the left could help a historian research the themes.</label>
                                        </div>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="reasoning" name="reasoning">I provided convincing reasons and evidence from the document why or why not the document is useful for research the themes.</label>
                                        </div>
