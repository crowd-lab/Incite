                    ...
                    <br>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                         <a data-toggle="collapse" href="#phase1-panel" id="phase1-link">Step <?php echo $task_seq; ?>.1: Summary and Tone</a>
                                    </h4>
                                </div>
                                <div id="phase1-panel" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p class="header-step">Step <?php echo $task_seq; ?>.1a: Please write a summary of the historical document on the left. It should be no more than <u>3</u> sentences and shouldn't change the meaning of the document.</p>
                                        <textarea id="summary" style="width:100%;" name="summary" rows="5" placeholder="Your shortened text here"></textarea>
                                        <br>
                                        <br>
                                        <p class="header-step">Step <?php echo $task_seq; ?>.1b: Please rate how much each of the following tones reflects the author's attitude towards the subject.</p>
                                        <table class="table">
                                            <thead>
                                                <th>Tone</th>
                                                <th>Not at all</th>
                                        ...
                                        <p class="header-step">Step <?php echo $task_seq; ?>.1c: Please provide your reasoning for ratings above.</i></p>
                        ...
                        <div class="panel-group" id="phase2-panel-group" style="display: none;">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" href="#phase2-panel" id="phase2-link">Step <?php echo $task_seq; ?>.2: Learn Historical Thinking (Summarizing)</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="phase3-panel" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <br>
                                        <br>
                                        <p class="header-step">Step <?php echo $task_seq; ?>.3b: Make sure your ratings of the tones are consistent with your answers to the 4 questions in Step <?php echo $task_seq; ?>.2.</p>
                                        <table class="table">
                                            <thead>
                                                <th>Tone</th>
                                                <th>Not at all</th>
                                        ...
                                        <p class="header-step">Step <?php echo $task_seq; ?>.3c: Please revise your reasoning to reflect your answers to the 4 questions in Step <?php echo $task_seq; ?>.2.</i></p>
