...
?>
    ...
    <div class="container-fluid" style="margin-left: 100px; margin-right: 100px;">
            ...
            <h2 style="text-align: center; color: red;">This is a long HIT so please be prepared to work for about 20-25 mins.</h2>
            ...
            <h4>Procedures</h4>
            <p>If you agree to participate, you will be asked to 1) take a pre-task test about a historical document , 2) do one task which may take maximum 10 minutes, 3) take a post-task test about another historical document, and 4) complete a post-task survey about your experience of the tasks (&lt; 10 minutes).</p>
            <h4>Risks</h4>
