        ...
        <div class="container-fluid">
            ...
            <div class="col-md-7">
                <div id="tagging-container">
                    ...
                    <p class="header-step">Step <?php echo $task_seq; ?>b: Answer the question above using the historical document. Remember, you should apply all historical thinking techniques you learned in the previous analyzing tasks and think like a historian.</p>
