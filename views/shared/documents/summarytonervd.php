                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="phase2-panel" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <p><b>Assessment: </b></p>
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="originality" name="originality">The worker wrote an original summary. I did not plagiarize.</label>
                                        </div>
                                        <div class="checkbox">
                                        ...
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="usefulness" name="usefulness">The worker wrote an honest and useful summary</label>
                                        </div>
                                        <div class="checkbox">
                                        ...
                                        <div class="checkbox">
                                            <label><input type="checkbox" value="" id="punctuation" name="punctuation">The worker used appropriate punctuation and capitalization.</label>
                                        </div>
                                        <div class="checkbox">
